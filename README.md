...
# Manual bridger
<a href="https://ibb.co/zSV1tts"><img src="https://i.ibb.co/jLkdjjh/manual-menu-1.png" alt="manual-menu-1" border="0"></a>
...
## Настройка (manual bridger)
 ...
 - **Wait for txn receipt** - ожидание пока транзакция попадёт в блокчейн
 - **Receipt timeout** - максимальное время ожидания попадания транзакции в блокчейн
 - **Test mode** - Можно запустить в тестовом режиме, скрипт проверит корректность транзы и покажет estimate gas
## Warmup Bridger
<a href="https://ibb.co/tMXr8VD"><img src="https://i.ibb.co/N6SBZcK/auto-menu-1.png" alt="auto-menu-1" border="0"></a>
...
- **Test mode** - Можно запустить в тестовом режиме, скрипт проверит корректность транзы и покажет estimate gas.
## STG staker
<a href="https://ibb.co/rQvpD92"><img src="https://i.ibb.co/gr6WkYZ/stg-stake-1.png" alt="stg-stake-1" border="0"></a>
...
## Liquidity adder
<a href="https://imgbb.com/"><img src="https://i.ibb.co/rQcWnmW/liquidity-adder-1.png" alt="liquidity-adder-1" border="0"></a>
